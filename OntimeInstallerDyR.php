...
$files= array('OnTime.php','OnTimetmp.php','OnTimeAllways.php','OnTimeDDD.php','OnTimeRecord.php','OTiDyR.php','OnTimeValid.php','OnTimeDebug.php');
echo 'Start '.'<br>';
